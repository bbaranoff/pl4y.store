...
---
fontcolor: "#0080FF" # {html} Color of text.
linkcolor: "#CD5C5C" # {html, pdf, beamer} Color of link text.
---
...
highlight-style: "a11y" # {html, pdf, docx, revealjs, beamer, epub} ["default",
...
---
bibliography: "bibliography.bib" # Path to BibTeX/Citation Style Language bibliography file
---
...
---
lang: "en-US" # Main language for document in IETF language tag format
---
