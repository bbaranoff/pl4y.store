---
title: "Mémoire(s)" # Title of the document
...
```{r, echo=FALSE}
myxlsx <- readxl::read_excel("protocols_glossary.xlsx")
rmarkdown::paged_table(myxlsx)
```
...
```{r, echo=FALSE}
mydata <- readxl::read_excel("mytab.xlsx",1)
rmarkdown::paged_table(head(mydata)) 
```
